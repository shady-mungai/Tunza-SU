  ...
  const validateCurrentStep = () => {
    ...
    for (const field of currentFields) {
      ...
      if (!value || (typeof value === "string" && !value.trim())) {
        Alert.alert(
          "Error",
          `Please fill in the ${getFieldDisplayName(field)} field`
        );
        return false;
      }
      ...
      switch (field) {
        ...
        case "admission_number":
          if (value.length < 3) {
            Alert.alert(
              "Error",
              "Please enter a valid admission number (at least 3 characters)"
            );
            return false;
          }
          break;
      ...
      <View style={{ marginBottom: 24 }}>
        ...
        <TextInput
          style={{
            ...
            paddingVertical: 12,
            borderWidth: 1,
            borderColor: validationErrors.admission_number
              ? "#f87171"
              : fieldsTouched.admission_number &&
        ...
        {fieldsTouched.admission_number &&
          formData.admission_number.trim() &&
          formData.admission_number.length >= 3 && (
            <Text style={{ fontSize: 12, color: "#10b981", marginTop: 4 }}>
      ...
      <View style={{ marginBottom: 24 }}>
        ...
        <TextInput
          style={{
            ...
            paddingVertical: 12,
            borderWidth: 1,
            borderColor: validationErrors.phone_number
              ? "#f87171"
              : fieldsTouched.phone_number &&
      ...
      <View style={{ marginBottom: 24 }}>
        ...
        >
          ...
          >
            ...
            <Picker.Item label="Maintenance Staff" value="maintenance_staff" />
      ...
      <View style={{ flex: 1 }}>
        <View style={{ marginBottom: 24 }}>
          ...
          <TextInput
            style={{
              ...
              borderWidth: 1,
              borderColor:
                fieldsTouched.password && passwordStrength.score < 5
                  ? "#f87171"
                  : fieldsTouched.password && passwordStrength.score >= 5
                  ? "#34d399"
                  : "#d1d5db",
        ...
        >
          <Text style={{ fontSize: 14, color: "#1e40af" }}>
            Hint: Use a mix of letters, numbers, and symbols to create a strong
            password
          </Text>
        </View>
      </View>
    ...
    <View style={{ flex: 1 }}>
      ...
      >
        <Text style={{ fontSize: 14, color: "#166534" }}>
          ✅ By creating an account, you agree to TunzaSU's Terms of Service and
          Privacy Policy
        </Text>
      </View>
    </View>
        ...
        <View style={{ maxWidth: 400, alignSelf: "center", width: "100%" }}>
          ...
          >
            {currentStep > 0 ? (
              ...
              >
                <Text
                  style={{ color: "#374151", fontWeight: "500", fontSize: 14 }}
                >
                  Back
                </Text>
              </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={
                currentStep === steps.length - 1 ? handleSignup : nextStep
              }
              disabled={isLoading}
              activeOpacity={0.8}
            >
